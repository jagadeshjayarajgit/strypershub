        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1 text-center lg:text-left z-10 relative">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-5">
                    ...
                    <button className="flex items-center gap-2 px-8 py-3.5 bg-transparent border border-green-500 rounded-full text-white font-semibold hover:bg-green-600 hover:border-green-600 transition-all group">
